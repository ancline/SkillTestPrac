                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="studFName" class="form-control" required value="<?= htmlspecialchars($edit['studFName'] ?? '') ?>">
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Last Name</label>
                            <input type="text" name="studLName" class="form-control" required value="<?= htmlspecialchars($edit['studLName'] ?? '') ?>">
                        </div>
                        <div class="mb-2">
                        ...
                        <?php if ($edit): ?>
                            ...
                            <a href="?page=registration" class="btn btn-secondary w-100 mt-2">Cancel</a>
                        <?php else: ?>
        ...
        <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <?php foreach (['Main', 'Banilad', 'LM', 'Pardo'] as $c): ?>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="campuses[]" value="<?= $c ?>"
                                <?= in_array($c, $selected_campuses) ? 'checked' : '' ?>>
            ...
            <?php if ($winner): ?>
                <div class="text-center mt-4">
                    ...
                    <h4 class="text-success fw-bold fst-italic">CONGRATULATIONS!!!</h4>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" class="mb-3">
                ...
                <?php foreach (['Main', 'Banilad', 'LM', 'Pardo'] as $c): ?>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="campuses_report[]" value="<?= $c ?>"
                            <?= in_array($c, $selected_report) ? 'checked' : '' ?>>
                        <label class="form-check-label"><?= $c ?></label>
                    </div>
                <?php endforeach; ?>
                <div class="mt-2">
