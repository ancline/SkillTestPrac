            ...
            <tbody>
                <?php while($row = $students->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?=  $row['address'] ?></td>
                        <td>
                            <a class="btn btn-primary btn-sm" href="?edit=<?= $row['id'] ?>">Edit</a>
                            <a class="btn btn-danger btn-sm" href="?delete=<?= $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this student?')">Delete</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
